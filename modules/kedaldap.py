...
USER = 'cn=admin,dc=kedachina,dc=com,dc=cn'
PASSWORD = 'kedaadmin'
BASE_DN = 'dc=kedachina,dc=com,dc=cn'
...
class LDAPTool:
    ...
    def ldap_update_passwd(self,uid=None,oldpass=None,newpass=None):
        ...
        # 修改用户邮箱,没有邮箱则新增邮箱
    def ldap_updata_mail(self,uid=None,newmail=None):
...
if __name__ == "__main__":
    ...
    # 搜索用户信息
    #c = a.ldap_get_user('xiexun')
    #print c
    # 进行用户验证
    d = a.ldap_get_vaild('liuxg','liuxg')
    print d
    #e = a.ldap_updata_mail('xiexun','xie_xun@126.com')
